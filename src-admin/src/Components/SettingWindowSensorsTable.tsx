...
export type SettingWindowSensorItem = {
    ...
    OID_Current: string;
    DataType: string;
    valueOpen: number | string | boolean;
    valueClosed: number | string | boolean;
};
...
export default function SettingWindowSensorsTable(props: Props): React.JSX.Element {
                        ...
                        <TableRow key={idx}>
                            ...
                            <TableCell>
                                <TextField
                                    fullWidth
                                    value={t.valueOpen}
                                    onChange={(e) => onUpdate(idx, 'valueOpen', e.target.value)}
                                    variant="standard"
                                    placeholder="true"
                                />
                            </TableCell>
                            ...
                            <TableCell>
                                <TextField
                                    fullWidth
                                    value={t.valueClosed}
                                    onChange={(e) => onUpdate(idx, 'valueClosed', e.target.value)}
                                    variant="standard"
                                    placeholder="false"
                                />
                            </TableCell>
