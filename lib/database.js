                ...
                if (theRoom.WindowIsOpen != newVal) {
                    ...
                    if (parentAdapter.config.ThermostatHandlesWindowOpen) {
                        if (theRoom.WindowIsOpen) {
                            ...
                            //braucht es das wirklich? ohne würden Änderungen vom Thermostat ignoroeiert werden, solange das fenster auf ist
                            theRoom.WindowOpenUntilTemperaturTimerId = setTimeout(WindowOpenUntilTemperaturTimeout, 10000, theRoom.Name);
                        }
                        else {
