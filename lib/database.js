    ...
    try {
        ...
        for (let room = 0; room < parentAdapter.config.rooms.length; room++) {
            ...
            if (parentAdapter.config.rooms[room].isActive) {
                ...
                parentAdapter.log.info("active room found: " + parentAdapter.config.rooms[room].name);
                ...
                sensors = await GetSensorsId4Room(sensors);
                ...
                addTempSensors = await GetAddTempSensorsId4Room(addTempSensors);
