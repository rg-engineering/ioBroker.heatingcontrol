        ...
        if (theRoom != null) {
            ...
            if (state == "Sensor") {
                ...
                if (theRoom.PublicHolidyToday != val) {
                    ...
                    //hier fehlt etwas...
                    //Neuberechnung der Zeiten (cron) undd damit Zieltemperaturen


                    changed = true;
                }
                theRoom.PublicHolidyToday = val;
                parentAdapter.log.warn("Change Status PublicHolidyToday in " + theRoom.Name + " to " + val);
            }
