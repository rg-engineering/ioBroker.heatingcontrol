...
async function CreateDatabase(adapter, language) {
    ...
    try {
        ...
        if (parentAdapter.config.enableCSVLogging) {
            ...
            csvlogger.StartLog(CSVPath, header);
        }
...
function WriteCsvLog(room, currentTemp, targetTemp) {
    if (parentAdapter.config.enableCSVLogging) {
        ...
        csvlogger.WriteCSVLog(0, records);
    }
}
    ...
    try {
        ...
        if (theRoom != null) {
            ...
            if (theRoom.State != "starting" && handleActors) {
                ...
                WriteCsvLog(theRoom.Name, theRoom.CurrentTemperature, theRoom.CurrentTarget);
            }
