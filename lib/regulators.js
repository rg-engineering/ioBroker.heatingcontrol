...
async function getStatus_linHyst(current, target, room) {
    ...
    if (HysteresisOnOffset != null && HysteresisOffOffset != null) {
        ...
        parentAdapter.log.error("unknown regulator hysteresis offset " + JSON.stringify(HysteresisOnOffset) + " " + JSON.stringify(HysteresisOffOffset) + " " + key);
    }
