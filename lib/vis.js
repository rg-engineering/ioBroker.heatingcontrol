        ...
        if (parentAdapter.config.VisUseSimple) {
            ...
            for (let x = 0; x < GetNumberOfActiveRooms(); x++) {
                ...
                if (theRoom.hasWindowSensors) {
                    ...
                    HtmlTable = HtmlTable + '<div class="mdui-label">' + theRoom.Name + '<div class="mdui-subtitle">' +  GetTranslation(parentAdapter, "since", SystemLanguage) + WindowStateTimeStamp[x] + "</div></div></div>";
                }
            }
        }
