...
async function SetTempDecreaseModeValueLists() { //Setzt die Vorgabewerte der Valuelists je nach gewähltem DecreaseMode
    ...
    try {
        ...
        await parentAdapter.setStateAsync("vis.TempValueListValue", { ack: true, val: TempValueListValue });
        await parentAdapter.setStateAsync("vis.TempValueListText", { ack: true, val: TempValueListText });
