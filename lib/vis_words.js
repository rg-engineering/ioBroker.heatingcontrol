...
const heatingcontrolDictionary = {
    ...
    current: { en: "current", de: "aktuell", ru: "текущее значение", pt: "atual", nl: "huidige waarde", fr: "valeur actuelle", it: "valore corrente", es: "valor actual", pl: "Bieżąca wartość", "zh-cn": "当前值" },
    ...
    current_int: {en: "current internal",de: "aktuell intern",ru: "текущий внутренний",pt: "atual interno",nl: "huidige interne",fr: "courant interne",it: "interno corrente",es: "actual interno",pl: "aktualny wewnętrzny","zh-cn": "当前内部"},
    current_ext: {en: "current external",de: "aktuell extern",ru: "текущий внешний",pt: "atual externo",nl: "huidige externe",fr: "externe actuel",it: "corrente esterna",es: "corriente externa",pl: "prąd zewnętrzny","zh-cn": "当前外部"},
    offset: {en: "offset",de: "Offset",ru: "компенсировать",pt: "Deslocamento",nl: "offset",fr: "décalage",it: "compensare",es: "compensar",pl: "zrównoważyć","zh-cn": "抵消"},
    ...
    TemperatureIfNoHeatingPeriod: { en: "Temperature if no heating period", de: "Temperatur außerhalb Heizperiode", ru: "Температура вне периода отопления", pt: "Temperatura fora do período de aquecimento", nl: "Temperatuur buiten verwarmingsperiode", fr: "Température hors période de chauffage", it: "Temperatura fuori dal periodo di riscaldamento", es: "Temperatura fuera del período de calefacción", pl: "Temperatura poza okresem grzewczym", "zh-cn": "供暖期之外的温度" },
    ...
    //notifications
    "set actor": {
        en: "actuator value set to",
        de: "Aktor-Stellwert eingestellt auf",
        ru: "значение привода, установленное для",
        pt: "valor do atuador definido para",
        nl: "actuator waarde ingesteld",
        fr: "actuator value set to",
        it: "valore attuatore impostato su",
        es: "valor del actuador",
        pl: "wartość ustawodawczą",
        uk: "набір значення активатора до",
        "zh-cn": "行为价值"
    },
    "set thermostat": {
        en: "thermostat value set to",
        de: "Thermostatwert eingestellt auf",
        ru: "значение термостата установлено к",
        pt: "valor termostato definido para",
        nl: "thermostaatwaarde klaar voor",
        fr: "thermostat valeur set to",
        it: "valore termostato impostato su",
        es: "valor termostato establecido",
        pl: "wartość termostatowa",
        uk: "комплект термостату до",
        "zh-cn": "a. 动荡价值"
    },
    "change window state": {
        en: "change Status Window is Open to",
        de: "Status Fenster geöffnet ist",
        ru: "изменить статус окна открыто для",
        pt: "alterar a janela de status está aberta",
        nl: "verandering Status Window is open",
        fr: "changement Statut Window est ouvert à",
        it: "cambiamento Stato finestra è aperto a",
        es: "cambio Estado Ventana está abierta",
        pl: "status Window jest otwarty",
        uk: "змінити вікно стану",
        "zh-cn": "改变现状是开放的"
    }
