...
const heatingcontrolDictionary = {
    ...
    //cardHzngMoFrSaSo
    "Period": { "en": "Per.", "de": "Per.", "ru": "Период", "pt": "Período", "nl": "Periode", "fr": "Point final", "it": "Periodo", "es": "Período", "pl": "Kropka", "zh-cn": "时期" },
    ...
    "SaSu": { "en": "Sa. to Su.", "de": "Sa. bis So.", "ru": "Sa. к вс.", "pt": "Sa. para Su.", "nl": "Za. naar zo.", "fr": "Sa. à Su.", "it": "Sa. a Su.", "es": "Sa. a su.", "pl": "Sa. do Su.", "zh-cn": "萨来苏。" },
    ...
    "ZeitenWoche": { "en": "Times / week ", "de": "Zeiten / Woche", "ru": "Раз в неделю", "pt": "Vezes / semana", "nl": "Tijden / week", "fr": "Horaires / semaine", "it": "Tempi / settimana", "es": "Tiempos / semana", "pl": "Razy / tydzień", "zh-cn": "次/周" },
    ...
    //cardDateAndTime
    "clock": { "en": "clock", "de": "Uhrzeit", "ru": "Часы", "pt": "relógio", "nl": "klok", "fr": "horloge", "it": "orologio", "es": "reloj", "pl": "zegar", "zh-cn": "钟" }
