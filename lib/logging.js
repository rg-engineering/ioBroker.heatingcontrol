...
function ActorLog(actor, target) {
    ...
    let msgtext = GetTranslation(parentAdapter, "set actor", SystemLanguage);
...
function ThermostatLog(roomName, thermostat, target) {
    ...
    let msgtext = GetTranslation(parentAdapter, "set thermostat", SystemLanguage);
...
function WindowLog(roomName, state) {
    ...
    let msgtext = GetTranslation(parentAdapter, "change window state", SystemLanguage);
...
function sendNotificationDiscord() {
    /*
    "discordInstance": "",
    "discordNoticeType": "longSignalNotice",
