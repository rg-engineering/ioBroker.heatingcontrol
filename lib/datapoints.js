    ...
    try {
        ...
        for (let room = 0; room < parentAdapter.config.rooms.length; room++) {
            if (parentAdapter.config.rooms[room].isActive) {
                ...
                await CreateDatapoint(key + ".CurrentTimePeriodTemperature", "state", "value", "number", "", true, false);
        ...
        if (parentAdapter.config.UseVisFromPittini) {
            ...
            await CreateDatapoint("vis.translations.cardHzngProfilParam.GuestTemperature", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.PartyDecrease", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.PartyTemperature", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.AbsentDecrease", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.AbsentTemperature", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.VacationAbsentDecrease", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.VacationAbsentTemperature", "state", "value", "string", "", true, false);

            if (parentAdapter.config.UseFireplaceMode) {
                await CreateDatapoint("vis.translations.cardHzngProfilParam.FireplaceModeDecrease", "state", "value", "string", "", true, false);
                await CreateDatapoint("vis.translations.cardHzngProfilParam.FireplaceModeTemperature", "state", "value", "string", "", true, false);
            }

            await CreateDatapoint("vis.translations.cardHzngProfilParam.WindowOpenDecrease", "state", "value", "string", "", true, false);
            await CreateDatapoint("vis.translations.cardHzngProfilParam.WindowOpenTemperature", "state", "value", "string", "", true, false);
            ...
            await CreateDatapoint("vis.translations.cardHzngProfilParam.MinimalTemperature", "state", "value", "string", "", true, false);
