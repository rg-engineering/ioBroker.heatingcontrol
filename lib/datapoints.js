...
async function CreateDatapoints(adapter) {
    ...
    try {
        ...
        if (parentAdapter.config.UseVisFromPittini) {
            ...
            await CreateDatapoint("vis.RoomValues.WindowIsOpen", "state", "value", "boolean", "°C", true, false);
            await CreateDatapoint("vis.RoomValues.CurrentTimePeriod", "state", "value", "number", "°C", true, true);
