...
systemDictionary = {
    "AdapterNotOnline": {
        ...
        "ru": "Адаптер не подключен ", "pt": "Adaptador não online. ",
        "nl": "Adapter niet online. ", "fr": "L'adaptateur n'est pas en ligne. ",
        "it": "Adattatore non in linea. ",
        "es": "El Adaptador No Está En Línea. Por favor, asegúrese de que está ejecutando!",
        "pl": "Adapter Nie Jest Online. Proszę, upewnij się, że działa!",
        "zh-cn": "适配器。 请确保它运行！"
    },
    "Cancel": {
        "en": "cancel",
    ...
    "FixHeatingPeriodEnd": {
        "en": "end of Heating Period", "de": "Ende der Heizperiode", "ru": "конец периода отопления", "pt": "fim do período de aquecimento", "nl": "einde van de verwarmingsperiode", "fr": "fin de la période de chauffage", "it": "fine del periodo di riscaldamento", "es": "final del Período de Calefacción", "pl": "koniec okresu grzewczego ", "zh-cn": "结束期间加热"
    },
    "FixHeatingPeriodStart": {
        "en": "begin of Heating Period", "de": "Beginn der Heizperiode", "ru": "начало отопительного периода", "pt": "início do período de aquecimento", "nl": "begin van de verwarmingsperiode", "fr": "début de la période de chauffage", "it": "inizio del periodo di riscaldamento", "es": "de comenzar el Periodo de Calentamiento", "pl": "początek okresu grzewczego ", "zh-cn": "开始热的时段"
    },
    "FixTempIfNoHeatingPeriod": {
        "en": "Fix Temperature if no heatingperiod", "de": "Feste Temperatur, wenn keine Heizperiode vorhanden ist", "ru": "Фиксировать температуру, если нет периода нагрева", "pt": "Temperatura fixa se não houver período de aquecimento", "nl": "Fix temperatuur als er geen verwarmingsperiode is", "fr": "Fixer la température si aucune période de chauffage", "it": "Temperatura fissa se nessun periodo di riscaldamento", "es": "Corrección de la Temperatura si no heatingperiod", "pl": "Naprawić temperaturę, jeśli nie heatingperiod", "zh-cn": "解决温度如果没有heatingperiod"
    },
    "Gewerk": {
        "en": "function", "de": "Funktion", "ru": "функция", "pt": "função", "nl": "functie", "fr": "une fonction", "it": "funzione", "es": "la función", "pl": "funkcja", "zh-cn": "功能"
    },
    "Main settings": {
    ...
    "Path2GuestsPresentDP": {
        "en": "Path to data point \"guests present\"", "de": "Pfad zum Datenpunkt \"Gäste anwesend\"", "ru": "Путь к точке данных \"гости присутствуют\"", "pt": "Caminho para o ponto de dados \"convidados presentes\"", "nl": "Pad naar datapunt \"gasten aanwezig\"", "fr": "Chemin vers le point de données \"invités présents\"", "it": "Percorso del punto dati \"ospiti presenti\"", "es": "Ruta de acceso del punto de datos \"huéspedes del presente\"", "pl": "Droga do punktu danych \"gości\"", "zh-cn": "路径的数据点\"嘉宾\""
    },
    "Path2HolidayPresentDP": {
        "en": "Path to data point \"holiday at home\"", "de": "Pfad zum Datenpunkt \"Urlaub zu Hause\"", "ru": "Путь к точке данных \"дом отдыха\"", "pt": "Caminho para o ponto de dados \"férias em casa\"", "nl": "Pad naar datapunt \"vakantie thuis\"", "fr": "Chemin vers le point de données \"vacances à la maison\"", "it": "Percorso del punto dati \"vacanza a casa\"", "es": "Ruta de acceso del punto de datos \"fiesta en casa\"", "pl": "Droga do punktu danych \"wakacje w domu\"", "zh-cn": "路径的数据点\"假期在家里\""
    },
    "Path2PartyNowDP": {
    ...
    "SensorOpenDelay": {
        "en": "Sensor Open Delay  [sec]",
        "de": "Verzögerung beim Öffnen des Sensors [Sek.]",
        "ru": "Задержка открытия датчика [сек]",
        "pt": "Atraso na abertura do sensor [seg]",
        "nl": "Sensor open vertraging [sec]",
        "fr": "Délai d'ouverture du capteur [sec]",
        "it": "Ritardo apertura sensore [sec]",
        "es": "Retraso de apertura del sensor [seg]",
        "pl": "Opóźnienie otwarcia czujnika [s]",
        "zh-cn": "传感器打开延迟[秒]"
    },
    "SensorCloseDelay": {
        "en": "Sensor Close Delay  [sec]",
        "de": "Verzögerung beim Schließen des Sensors [Sek.]",
        "ru": "Задержка закрытия датчика [сек]",
        "pt": "Atraso de fechamento do sensor [seg]",
        "nl": "Sensor sluitvertraging [sec]",
        "fr": "Délai de fermeture du capteur [sec]",
        "it": "Ritardo chiusura sensore [sec]",
        "es": "Retardo de cierre del sensor [seg]",
        "pl": "Opóźnienie zamknięcia czujnika [s]",
        "zh-cn": "传感器关闭延迟[秒]"
    },
    "TemperatureDecrease": {
        "en": " temperature lowering", "de": " Temperaturabsenkung", "ru": "понижение температуры", "pt": "abaixamento da temperatura", "nl": "temperatuurverlaging", "fr": "abaissement de la température", "it": "abbassamento della temperatura", "es": " la reducción de la temperatura", "pl": " obniżenie temperatury ", "zh-cn": " 温度降低"
    },
    "ThermostatModeIfNoHeatingperiod": {
        "en": "Thermostat mode if no heatingperiod", "de": "Thermostatmodus, wenn keine Heizperiode vorhanden ist", "ru": "Режим термостата, если нет отопительного периода", "pt": "Modo termostato se não houver período de aquecimento", "nl": "Thermostaatmodus als er geen verwarmingsperiode is", "fr": "Mode thermostat en l'absence de période de chauffage", "it": "Modalità termostato se nessun periodo di riscaldamento", "es": "Modo del termostato, si no heatingperiod", "pl": "Trybie termostatu, jeśli nie heatingperiod", "zh-cn": "恒温模式，如果没有heatingperiod"
    },
    "UseActorsIfNoThermostat": {
        "en": "use actuators if no thermostat available", "de": "Verwendung der Stellantriebe, wenn kein Thermostat vorhanden ist", "ru": "используйте приводы, если термостат недоступен", "pt": "use atuadores se não houver termostato disponível", "nl": "gebruik actuatoren als er geen thermostaat beschikbaar is", "fr": "utiliser des actionneurs si aucun thermostat n'est disponible", "it": "utilizzare gli attuatori se non è disponibile un termostato", "es": "el uso de actuadores si no hay termostato disponible", "pl": "korzystanie z napędów, jeśli nie termostat jest", "zh-cn": "使用致动器如果没有恒温器可用"
    },
    "UseActorsIfNotHeating": {
        "en": "use actuators if no heating period", "de": "Verwendung der Stellantriebe, wenn keine Heizperiode vorliegt", "ru": "используйте приводы, если нет периода нагрева", "pt": "use atuadores se não houver período de aquecimento", "nl": "gebruik actuatoren als er geen verwarmingsperiode is", "fr": "utiliser des actionneurs si aucune période de chauffage", "it": "utilizzare gli attuatori se non è presente il periodo di riscaldamento", "es": "el uso de actuadores si no hay tiempo de calentamiento", "pl": "korzystanie z napędów, jeśli nie ma sezonu grzewczego", "zh-cn": "使用致动器如果没有暖气的时期"
    },
    "UseChangesFromThermostat": {
        "en": "use of changes from thermostat", "de": "Verwendung von Änderungen vom Thermostat", "ru": "использование изменений от термостата", "pt": "uso de alterações do termostato", "nl": "gebruik van wijzigingen van thermostaat", "fr": "utilisation des changements du thermostat", "it": "uso delle modifiche dal termostato", "es": "el uso de los cambios de termostato", "pl": "wykorzystanie zmiany od termostatu", "zh-cn": "使用的变化从恒温器"
    },
    "UseFixHeatingPeriod": {
        "en": "Use predefined Heating Period", "de": "Vordefinierte Heizperiode verwenden", "ru": "Использовать предопределенный период нагрева", "pt": "Use período de aquecimento predefinido", "nl": "Gebruik vooraf gedefinieerde verwarmingsperiode", "fr": "Utiliser une période de chauffage prédéfinie", "it": "Usa periodo di riscaldamento predefinito", "es": "El uso de predefinidos Período de Calefacción", "pl": "Użyć wstępnie zdefiniowany okres ogrzewanie ", "zh-cn": "使用预热的时期"
    },
    "UseMinTempPerRoom": {
        "en": "use minimum temperature per room", "de": "Mindesttemperatur pro Raum verwenden", "ru": "используйте минимальную температуру на комнату", "pt": "use temperatura mínima por quarto", "nl": "gebruik minimum temperatuur per kamer", "fr": "utiliser une température minimale par pièce", "it": "utilizzare la temperatura minima per stanza", "es": "uso mínimo de la temperatura de la habitación", "pl": "użyj minimalną temperaturę w pokoju", "zh-cn": "使用最低温度每间房"
    },
    "UseVisFromPittini": {
        "en": "use of visualisation project from Pittini", "de": "Verwendung des Visualisierungsprojekts von Pittini", "ru": "использование проекта визуализации от Pittini", "pt": "uso do projeto de visualização da Pittini", "nl": "gebruik van visualisatieproject van Pittini", "fr": "utilisation du projet de visualisation de Pittini", "it": "utilizzo del progetto di visualizzazione di Pittini", "es": "uso de la visualización del proyecto de Pittini", "pl": "korzystanie z projektu wizualizacji od Pittini", "zh-cn": "使用的可视化项目，从Pittini"
    },
    "absolute": {
        "en": "absolute", "de": "absolut", "ru": "абсолютный", "pt": "absoluto", "nl": "absoluut", "fr": "absolu", "it": "assoluto", "es": "absoluta", "pl": "absolutna", "zh-cn": "绝对的"
    },
    "active": {
        "en": "active", "de": "aktiv", "ru": "активный", "pt": "ativo", "nl": "actief", "fr": "actif", "it": "attivo", "es": "activo", "pl": "aktywny", "zh-cn": "活性"
    },
    "actor": {
        "en": "actuator", "de": "Aktuator", "ru": "привод", "pt": "atuador do", "nl": "actuator", "fr": "actionneur", "it": "attuatore", "es": "actuador", "pl": "napęd", "zh-cn": "致动器"
    },
    "actors": {
        "en": "actuators", "de": "Aktoren", "ru": "приводы", "pt": "atuadores", "nl": "aandrijvingen", "fr": "actionneurs", "it": "attuatori", "es": "actuadores", "pl": "napędy", "zh-cn": "执行器"
    },
    "adjustable_per_room": {
        "en": "adjustable per room", "de": "pro Raum einstellbar", "ru": "регулируемый на номер", "pt": "ajustável por quarto", "nl": "per kamer instelbaar", "fr": "réglable par chambre", "it": "regolabile per camera", "es": "ajustable por habitación", "pl": "regulowany za pokój", "zh-cn": "可调整的每间房"
    },
    "as_new_profile_setting": {
        "en": "as new profile setting", "de": "als neue Profileinstellung", "ru": "как новая настройка профиля", "pt": "como nova configuração de perfil", "nl": "als nieuwe profielinstelling", "fr": "comme nouveau paramètre de profil", "it": "come nuova impostazione del profilo", "es": "como la nueva configuración de perfil", "pl": "jak nowe ustawienia profilu ", "zh-cn": "作为新配置的设置"
    },
    "until_next_profile_point": {
        "en": "until next profile point",
        "de": "bis zum nächsten Profilpunkt",
        "ru": "до следующей точки профиля",
        "pt": "até o próximo ponto de perfil",
        "nl": "tot het volgende profielpunt",
        "fr": "jusqu'au prochain point de profil",
        "it": "fino al punto del profilo successivo",
        "es": "hasta el siguiente punto de perfil",
        "pl": "do następnego punktu profilu",
        "zh-cn": "直到下一个轮廓点"
    },
    "as_override": {
    ...
    "every Day": {
        "en": "every Day separately", "de": "jeden Tag getrennt", "ru": "каждый день отдельно", "pt": "todos os dias separadamente", "nl": "elke dag afzonderlijk", "fr": "chaque jour séparément", "it": "ogni giorno separatamente", "es": "cada Día por separado", "pl": "każdy dzień osobno", "zh-cn": "每天分别"
    },
    "fixTempForAll": {
        "en": "fix Temperature for all rooms", "de": "Fix Temperatur für alle Räume", "ru": "установить температуру для всех комнат", "pt": "temperatura fixa para todos os quartos", "nl": "fix Temperatuur voor alle kamers", "fr": "fixer la température pour toutes les pièces", "it": "temperatura fissa per tutte le stanze", "es": "corrección de Temperatura para todas las habitaciones", "pl": "naprawić temperaturę do wszystkich pomieszczeń", "zh-cn": "解决温度为所有的房间"
    },
    "fixTempPerRoom": {
        "en": "fix Temperature per room", "de": "Fix Temperatur pro Raum", "ru": "фиксировать температуру в комнате", "pt": "temperatura fixa por quarto", "nl": "fix Temperatuur per kamer", "fr": "Fixer la température par pièce", "it": "temperatura fissa per stanza", "es": "corrección de la Temperatura de la habitación", "pl": "przymocować temperaturę w pomieszczeniu", "zh-cn": "解决温室每"
    },
    "hint_vis_from_Pittini": {
        "en": "this option integrates javascript script from Pittini into the adapter. A separate script is not necessary anymore. If you still like to use the script  or you do not use Pittini's visualisation project at all then disable that option", "de": "Diese Option integriert das Javascript-Skript von Pittini in den Adapter. Ein separates Skript ist nicht mehr erforderlich. Wenn Sie das Skript weiterhin verwenden möchten oder das Visualisierungsprojekt von Pittini überhaupt nicht verwenden, deaktivieren Sie diese Option", "ru": "эта опция интегрирует JavaScript-скрипт из Pittini в адаптер. ", "pt": "essa opção integra o script javascript da Pittini no adaptador. ", "nl": "deze optie integreert javascript-script van Pittini in de adapter. ", "fr": "cette option intègre le script javascript de Pittini dans l'adaptateur. ", "it": "questa opzione integra lo script javascript di Pittini nell'adattatore. ", "es": "esta opción se integra a la secuencia de comandos de javascript de Pittini en el adaptador. Una secuencia de comandos independiente no es necesario más. Si usted todavía desea utilizar la secuencia de comandos o no uso Pittini la visualización del proyecto en todas, a continuación, deshabilitar esa opción", "pl": "parametr ten łączy skryptu JavaScript z Pittini w adapter. Więcej oddzielny skrypt nie trzeba. Jeśli nadal chcesz używać skryptu lub nie używasz projekt wizualizacji Pittini w ogóle wyłączyć tę opcję", "zh-cn": "这项集javascript脚本Pittini到适配器。 一个单独的脚本是没有必要了。 如果你还喜欢用脚本，或者不使用Pittini的可视化项目在所有禁止选择"
    },
    "no lowering": {
        "en": "no lowering", "de": "kein Absenken", "ru": "нет понижения", "pt": "sem baixar", "nl": "geen verlaging", "fr": "pas d'abaissement", "it": "nessun abbassamento", "es": "no bajar", "pl": "nie ma spadku", "zh-cn": "没有降低"
    },
    "nothing": {
        "en": "nothing", "de": "nichts", "ru": "ничего", "pt": "nada", "nl": "niets", "fr": "rien", "it": "Niente", "es": "nada", "pl": "nic", "zh-cn": "没有什么"
    },
    "off": {
        "en": "off", "de": "aus", "ru": "от", "pt": "fora", "nl": "uit", "fr": "de", "it": "via", "es": "off", "pl": "od", "zh-cn": "关闭"
    },
    "on": {
        "en": "on", "de": "an", "ru": "на", "pt": "em", "nl": "Aan", "fr": "sur", "it": "sopra", "es": "en", "pl": "na", "zh-cn": "上"
    },
    "profile": {
        "en": "profile", "de": "Profil", "ru": "профиль", "pt": "perfil", "nl": "profiel", "fr": "profil", "it": "profilo", "es": "perfil", "pl": "profil", "zh-cn": "配置文件"
    },
    "relative": {
        "en": "relative", "de": "relativ", "ru": "относительный", "pt": "relativo", "nl": "familielid", "fr": "relatif", "it": "parente", "es": "relativa", "pl": "względne", "zh-cn": "相对"
    },
    "room": {
        "en": "room", "de": "Zimmer", "ru": "номер", "pt": "sala", "nl": "kamer", "fr": "chambre", "it": "camera", "es": "habitación", "pl": "pokój", "zh-cn": "房间"
    },
    "sensor": {
    ...
    "timezone": {
        "en": "timezone", "de": "Zeitzone", "ru": "часовой пояс", "pt": "fuso horário", "nl": "tijdzone", "fr": "fuseau horaire", "it": "fuso orario", "es": "la zona horaria", "pl": "strefa czasowa", "zh-cn": "时区"
    },
    "use_actors": {
        "en": "actuators used", "de": "Aktoren verwendet", "ru": "используемые приводы", "pt": "atuadores usados", "nl": "gebruikte actuatoren", "fr": "actionneurs utilisés", "it": "attuatori utilizzati", "es": "actuadores utilizados", "pl": "napędy stosowane", "zh-cn": "执行器的使用"
    },
    "use_sensors": {
        "en": "sensors used", "de": "Sensoren verwendet", "ru": "датчики используются", "pt": "sensores usados", "nl": "sensoren gebruikt", "fr": "capteurs utilisés", "it": "sensori utilizzati", "es": "los sensores usados", "pl": "czujniki stosowane", "zh-cn": "传感器的使用"
    },
    "hint_thermostats": {
        "en": "Please configure here your thermostats for that room. select datapoint where target temperature needs to be set. OID_Current is used for datapoint where current room temperature is measured. ",
        "de": "Bitte konfigurieren Sie hier Ihre Thermostate für diesen Raum. Wählen Sie einen Datenpunkt aus, an dem die Zieltemperatur eingestellt werden muss. OID_Current wird für einen Datenpunkt verwendet, an dem die aktuelle Raumtemperatur gemessen wird.",
        "ru": "Пожалуйста, настройте здесь свои термостаты для этой комнаты. выберите точку данных, где необходимо установить целевую температуру. OID_Current используется для точки данных, где измеряется текущая температура в помещении.",
        "pt": "Por favor, configure aqui seus termostatos para essa sala. selecione ponto de dados onde a temperatura alvo precisa ser definida. OID_Current é usado para o ponto de dados em que a temperatura ambiente atual é medida.",
        "nl": "Configureer hier uw thermostaten voor die kamer. selecteer datapunt waar de doeltemperatuur moet worden ingesteld. OID_Current wordt gebruikt voor datapunt waar de huidige kamertemperatuur wordt gemeten.",
        "fr": "Veuillez configurer ici vos thermostats pour cette pièce. sélectionnez le point de données où la température cible doit être définie. OID_Current est utilisé pour le point de données où la température ambiante actuelle est mesurée.",
        "it": "Configura qui i tuoi termostati per quella stanza. selezionare il punto dati in cui è necessario impostare la temperatura target. OID_Current viene utilizzato per il punto dati in cui viene misurata la temperatura ambiente corrente.",
        "es": "Configure aquí sus termostatos para esa habitación. seleccione el punto de datos donde se debe establecer la temperatura objetivo. OID_Current se utiliza para el punto de datos donde se mide la temperatura ambiente actual.",
        "pl": "Skonfiguruj tutaj swoje termostaty dla tego pokoju. wybierz punkt danych, w którym należy ustawić docelową temperaturę. OID_Current służy do punktu danych, w którym mierzona jest bieżąca temperatura pokojowa.",
        "zh-cn": "请在此处配置该房间的恒温器。选择需要设置目标温度的数据点。 OID_Current用于测量当前室温的数据点。"
    },
    "hint_sensors": {
        "en": "Please configure here your window / door sensors. Only those sensors can be used here. Do not add any temperature sensors or similar.",
        "de": "Bitte konfigurieren Sie hier Ihre Fenster- / Türsensoren. Hier können nur diese Sensoren verwendet werden. Fügen Sie keine Temperatursensoren oder ähnliches hinzu.",
        "ru": "Пожалуйста, настройте здесь ваши датчики окна / двери. Здесь можно использовать только эти датчики. Не добавляйте датчики температуры или аналогичные.",
        "pt": "Por favor, configure aqui os seus sensores de janela / porta. Somente esses sensores podem ser usados aqui. Não adicione nenhum sensor de temperatura ou similar.",
        "nl": "Configureer hier uw raam- / deursensoren. Alleen die sensoren kunnen hier worden gebruikt. Voeg geen temperatuursensoren of iets dergelijks toe.",
        "fr": "Veuillez configurer ici vos capteurs de fenêtre / porte. Seuls ces capteurs peuvent être utilisés ici. N'ajoutez aucun capteur de température ou similaire.",
        "it": "Configura qui i tuoi sensori per porte e finestre. Solo quei sensori possono essere usati qui. Non aggiungere sensori di temperatura o simili.",
        "es": "Configure aquí sus sensores de ventana / puerta. Solo esos sensores se pueden usar aquí. No agregue ningún sensor de temperatura o similar.",
        "pl": "Skonfiguruj tutaj swoje czujniki okien / drzwi. Można tu zastosować tylko te czujniki. Nie dodawaj żadnych czujników temperatury ani podobnych.",
        "zh-cn": "请在此处配置您的窗户/门传感器。在这里只能使用那些传感器。请勿添加任何温度传感器或类似物。"
    },
    "hint_actors": {
        "en": "Please configure here your actuators. Those actuators are only necessar if you would like to control valves directly from that adapter. Under normol circumstances, where you use thermostats those actuators are not necessary.",
        "de": "Bitte konfigurieren Sie hier Ihre Aktoren. Diese Stellantriebe sind nur erforderlich, wenn Sie Ventile direkt von diesem Adapter aus steuern möchten. Unter normalen Umständen, wenn Sie Thermostate verwenden, sind diese Aktuatoren nicht erforderlich.",
        "ru": "Пожалуйста, настройте здесь свои приводы. Эти приводы необходимы только в том случае, если вы хотите управлять клапанами непосредственно с этого адаптера. В нормальных условиях, когда вы используете термостаты, эти приводы не нужны.",
        "pt": "Por favor, configure aqui seus atuadores. Esses atuadores são necessários apenas se você quiser controlar as válvulas diretamente desse adaptador. Sob circunstâncias normol, onde você usa termostatos, esses atuadores não são necessários.",
        "nl": "Configureer hier uw actuatoren. Die aandrijvingen zijn alleen nodig als je kleppen direct vanaf die adapter wilt aansturen. Onder normale omstandigheden, waarbij je thermostaten gebruikt, zijn die actuatoren niet nodig.",
        "fr": "Veuillez configurer ici vos actionneurs. Ces actionneurs ne sont nécessaires que si vous souhaitez contrôler les vannes directement à partir de cet adaptateur. Dans des circonstances normales, lorsque vous utilisez des thermostats, ces actionneurs ne sont pas nécessaires.",
        "it": "Configura qui i tuoi attuatori. Tali attuatori sono necessari solo se si desidera controllare le valvole direttamente da quell'adattatore. In circostanze normali, in cui si utilizzano termostati, tali attuatori non sono necessari.",
        "es": "Configure aquí sus actuadores. Esos actuadores solo son necesarios si desea controlar las válvulas directamente desde ese adaptador. En circunstancias normales, cuando utiliza termostatos, esos actuadores no son necesarios.",
        "pl": "Skonfiguruj tutaj swoje siłowniki. Te siłowniki są niezbędne tylko wtedy, gdy chcesz sterować zaworami bezpośrednio z tego adaptera. W warunkach normolowych, gdy używasz termostatów, siłowniki te nie są konieczne.",
        "zh-cn": "请在此处配置您的执行器。仅当您想直接从该适配器控制阀时，才需要这些执行器。在normol环境下，如果使用恒温器，则不需要这些执行器。"
    },
    "PittiniPathImageWindowOpen": {
        "en": "path to image \"window open\"",
        "de": "Pfad zum Bild \"Fenster offen\"",
        "ru": "путь к изображению \"окно открыто\"",
        "pt": "caminho para a imagem \"janela aberta\"",
        "nl": "pad naar afbeelding \"venster open\"",
        "fr": "chemin vers l'image \"fenêtre ouverte\"",
        "it": "percorso dell'immagine \"finestra aperta\"",
        "es": "ruta a la imagen \"ventana abierta\"",
        "pl": "ścieżka do obrazu „otwarte okno”",
        "zh-cn": "图像“窗口打开”的路径"
    },
    "PittiniPathImageWindowClosed": {
        "en": "path to image \"window closed\"",
        "de": "Pfad zum Bild \"Fenster geschlossen\"",
        "ru": "путь к изображению \"окно закрыто\"",
        "pt": "caminho para a imagem \"janela fechada\"",
        "nl": "pad naar afbeelding \"venster gesloten\"",
        "fr": "chemin vers l'image \"fenêtre fermée\"",
        "it": "percorso dell'immagine \"finestra chiusa\"",
        "es": "ruta a la imagen \"ventana cerrada\"",
        "pl": "ścieżka do obrazu „okno zamknięte”",
        "zh-cn": "图像“窗口关闭”的路径"
    },
    "no": {
        "en": "none",
    ...
    "Path2PartyNowDPType": {
        "en": "Type of data point \"party now\"",
        "de": "Art des Datenpunktes \"Party now\"",
        "ru": "Тип точки данных \"вечеринка сейчас\"",
        "pt": "Tipo de ponto de dados \"festa agora\"",
        "nl": "Type gegevenspunt 'party now'",
        "fr": "Type de point de données \"fête maintenant\"",
        "it": "Tipo di punto dati \"party now\"",
        "es": "Tipo de punto de datos \"fiesta ahora\"",
        "pl": "Typ punktu danych „Rozpocznij teraz”",
        "zh-cn": "数据点类型“立即参加聚会”"
    },
    "Path2PartyNowDPLimit": {
        "en": "Limit for data point \"party now\"",
        "de": "Limit für Datenpunkt \"Party now\"",
        "ru": "Ограничение для точки данных \"вечеринка сейчас\"",
        "pt": "Limite para ponto de dados \"festa agora\"",
        "nl": "Limiet voor gegevenspunt \"party now\"",
        "fr": "Limite pour le point de données \"Party now\"",
        "it": "Limite per il punto dati \"party now\"",
